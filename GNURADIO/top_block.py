...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Pn_range = qtgui.Range(0, 0.1, 0.1/100, 0, 200)
        self._Pn_win = qtgui.RangeWidget(self._Pn_range, self.set_Pn, "Potencia del ruido", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._Pn_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Delay_eye_range = qtgui.Range(0, (Sps-1), 1, (int(Sps/2)-1), 200)
        self._Delay_eye_win = qtgui.RangeWidget(self._Delay_eye_range, self.set_Delay_eye, "Centering the Eye", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._Delay_eye_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._BW_filtro_range = qtgui.Range(0, Fmax, Fmax/100, Fmax, 200)
        self._BW_filtro_win = qtgui.RangeWidget(self._BW_filtro_range, self.set_BW_filtro, "'BW_filtro'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._beta_range = qtgui.Range(0, 1, 1/100, 1, 200)
