...
import Acumulador_epy_block_0_0 as epy_block_0_0  # embedded python block
import Acumulador_epy_block_0_2 as epy_block_0_2  # embedded python block
import sip
...
class Acumulador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0_0.set_block_alias("Señal con ruido")
        self.qtgui_number_sink_0_4_1 = qtgui.number_sink(
            gr.sizeof_float,
            0,
        ...
        self.qtgui_number_sink_0_4_1.set_update_time(0.10)
        self.qtgui_number_sink_0_4_1.set_title("Desviacion estandar")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_4_1.set_min(i, -1)
            self.qtgui_number_sink_0_4_1.set_max(i, 1)
            self.qtgui_number_sink_0_4_1.set_color(i, colors[i][0], colors[i][1])
            if len(labels[i]) == 0:
                self.qtgui_number_sink_0_4_1.set_label(i, "Data {0}".format(i))
            else:
                self.qtgui_number_sink_0_4_1.set_label(i, labels[i])
            self.qtgui_number_sink_0_4_1.set_unit(i, units[i])
            self.qtgui_number_sink_0_4_1.set_factor(i, factor[i])

        self.qtgui_number_sink_0_4_1.enable_autoscale(False)
        self._qtgui_number_sink_0_4_1_win = sip.wrapinstance(self.qtgui_number_sink_0_4_1.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_number_sink_0_4_1_win)
        ...
        self.qtgui_number_sink_0_4.set_title("Desviacion estandar SF")
        ...
        self.qtgui_number_sink_0_3_1 = qtgui.number_sink(
            gr.sizeof_float,
            0,
            qtgui.NUM_GRAPH_HORIZ,
            1,
        ...
        self.qtgui_number_sink_0_3_1.set_update_time(0.10)
        self.qtgui_number_sink_0_3_1.set_title("Media")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_3_1.set_min(i, -1)
            self.qtgui_number_sink_0_3_1.set_max(i, 1)
            self.qtgui_number_sink_0_3_1.set_color(i, colors[i][0], colors[i][1])
            if len(labels[i]) == 0:
                self.qtgui_number_sink_0_3_1.set_label(i, "Data {0}".format(i))
            else:
                self.qtgui_number_sink_0_3_1.set_label(i, labels[i])
            self.qtgui_number_sink_0_3_1.set_unit(i, units[i])
            self.qtgui_number_sink_0_3_1.set_factor(i, factor[i])

        self.qtgui_number_sink_0_3_1.enable_autoscale(False)
        self._qtgui_number_sink_0_3_1_win = sip.wrapinstance(self.qtgui_number_sink_0_3_1.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_number_sink_0_3_1_win)
        ...
        self.qtgui_number_sink_0_3.set_title("Media SF")
        ...
        self.qtgui_number_sink_0_2_1 = qtgui.number_sink(
            gr.sizeof_float,
            0,
            qtgui.NUM_GRAPH_HORIZ,
            1,
        ...
        self.qtgui_number_sink_0_2_1.set_update_time(0.10)
        self.qtgui_number_sink_0_2_1.set_title("Potencia promedio")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_2_1.set_min(i, -1)
            self.qtgui_number_sink_0_2_1.set_max(i, 1)
            self.qtgui_number_sink_0_2_1.set_color(i, colors[i][0], colors[i][1])
            if len(labels[i]) == 0:
                self.qtgui_number_sink_0_2_1.set_label(i, "Data {0}".format(i))
            else:
                self.qtgui_number_sink_0_2_1.set_label(i, labels[i])
            self.qtgui_number_sink_0_2_1.set_unit(i, units[i])
            self.qtgui_number_sink_0_2_1.set_factor(i, factor[i])

        self.qtgui_number_sink_0_2_1.enable_autoscale(False)
        self._qtgui_number_sink_0_2_1_win = sip.wrapinstance(self.qtgui_number_sink_0_2_1.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_number_sink_0_2_1_win)
        ...
        self.qtgui_number_sink_0_2.set_title("Potencia promedio SF")
        ...
        self.qtgui_number_sink_0_1_1.set_title("RMS")
        ...
        self.qtgui_number_sink_0_1.set_title("RMS SF")
        ...
        self.qtgui_number_sink_0_0_1.set_title("Media cuadratica")
        ...
        self.qtgui_number_sink_0_0.set_title("Media cuadratica SF")
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, 10000, True, 0 if "auto" == "auto" else max( int(float(0.1) * 10000) if "auto" == "time" else int(0.1), 1) )
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(10000, analog.GR_SQR_WAVE, 1000, 1, (-0.5), 0)
        ...
        self.connect((self.epy_block_0, 3), (self.qtgui_number_sink_0_2, 0))
        self.connect((self.epy_block_0, 0), (self.qtgui_number_sink_0_3, 0))
        self.connect((self.epy_block_0, 4), (self.qtgui_number_sink_0_4, 0))
        self.connect((self.epy_block_0_0, 0), (self.epy_block_0_2, 0))
        self.connect((self.epy_block_0_2, 1), (self.qtgui_number_sink_0_0_1, 0))
        self.connect((self.epy_block_0_2, 2), (self.qtgui_number_sink_0_1_1, 0))
        self.connect((self.epy_block_0_2, 3), (self.qtgui_number_sink_0_2_1, 0))
        self.connect((self.epy_block_0_2, 0), (self.qtgui_number_sink_0_3_1, 0))
        self.connect((self.epy_block_0_2, 4), (self.qtgui_number_sink_0_4_1, 0))
